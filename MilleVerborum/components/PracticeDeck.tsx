...
export default function PracticeDeck(props: Props) {
    ...
    // Reveal deck state only when both data loading AND intermission animation are complete
    useEffect(() => {
    ...
    const renderFlippedCard = useCallback((data: WordRowType, index: number) => {
        return (
            <Card 
                nativeText={data.nativeWord} 
                foreignText={data.foreignWord} 
        ...
        <GestureHandlerRootView style={{ flex: 1 }}>
            ...
            >
                ...
                {(finishedDeck && !exitingDeck) && (
                    ...
                    >
                        <Pressable onPress={handleReset} style={styles.practicePressable}>
                            <MaskedView
