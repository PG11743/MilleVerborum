...
import {
  ...
  Fill,
  center,
  usePathValue, // Added this import
...
const DonutChart: FC<CircularProgressProps> = ({
  ...
  // We use usePathValue to create and manage the Path object on the UI thread.
  // This avoids recreating the path on every React render.
  const path = usePathValue((p) => {
    "worklet";
    p.rewind(); // Clear previous geometry
